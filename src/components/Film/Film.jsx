...
export default function Flim(props) {
    ...
    return (
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative mr-5">
            <div style={{ background: `url(${phim.hinhAnh}) ,url(https://picsum.photos/300)`, backgroundPosition: 'center', backgroundSize: '100%' }}>

                <img src={phim.hinhAnh} alt={phim.tenPhim} style={{ height: '200px' }} className="opacity-0" />
            </div>
